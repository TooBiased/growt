...
template<class HashFct = std::hash<typename simple_element::Key>, class Allocator = std::allocator<char> >
...
using uaxGrow  = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratUser, EStratAsync>;

template<class HashFct    = std::hash<typename simple_element::Key>,
         class Allocator  = std::allocator<char> >
using usxGrow  = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratUser, EStratSync>;

template<class HashFct    = std::hash<typename simple_element::Key>,
         class Allocator  = std::allocator<char> >
using usnxGrow = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratUser, EStratSyncNUMA>;


template<class HashFct    = std::hash<typename markable_element::Key>,
         class Allocator  = std::allocator<char> >
using paxGrow  = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratPool, EStratAsync>;

template<class HashFct    = std::hash<typename simple_element::Key>,
         class Allocator  = std::allocator<char> >
using psxGrow  = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratPool, EStratSync>;

template<class HashFct   = std::hash<typename simple_element::Key>,
         class Allocator = std::allocator<char> >
using psnxGrow = grow_table<NoGrow<markable_element, HashFct, Allocator>, WStratPool, EStratSyncNUMA>;
